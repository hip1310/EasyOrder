...
export default function CheckoutForm() {
  ...
  return (
    <div className="md:p-12 mt-20" style={{marginTop:"100px", marginLeft:"30%", marginRight:"30%"}}>
      <div className="my-0 mx-auto md:w-2/5 w-4/5 md:static fixed md:top-auto top-2/4 md:left-auto left-2/4 md:transform-none translate-y-[-50%] translate-x-[-50%]">
        ...
        >
          ...
          />
          <div className="flex mt-2.5" style={{marginTop:"20px", textAlign:"center"}}>
            <Button
             variant="contained"
            ...
            <Button
              ...
              variant="contained"
             style={{ background: "#333", marginLeft:"10px"}}
              onClick={() => {
